...
const UpdateBankModal = ({
  ...
  useEffect(() => {
    if (account) {
      ...
      setIFSC_Code(account.IFSC_Code || "");
  ...
  return (
    <>
      ...
      <div
        className={`backdrop ${showUpdateModal ? "show" : ""}`}
        ...
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            <div className="modal-footer">
              ...
              <button className="btn btn-success" onClick={handleUpdateBank}>
                Update Bank
              </button>
              <button className="btn btn-secondary" onClick={toggleUpdateModal}>
                Close
              </button>
            </div>
          </div>
